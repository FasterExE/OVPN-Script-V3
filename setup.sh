...
*#!/bin/bash
wget https://raw.githubusercontent.com/FasterExE/OVPN-Script-V3/main/data/telegram-bot.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/FasterExE/OVPN-Script-V3/main/data/install_require.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/FasterExE/OVPN-Script-V3/main/data/install_apache2.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/FasterExE/OVPN-Script-V3/main/data/install_socks.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/FasterExE/OVPN-Script-V3/main/data/install_domain.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/FasterExE/OVPN-Script-V3/main/data/install_menu.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/FasterExE/OVPN-Script-V3/main/data/install_openvpn.sh >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/FasterExE/OVPN-Script-V3/main/data/install_stunnel.sh >/dev/null 2>&1
...
sleep 6
clear
wget https://raw.githubusercontent.com/FasterExE/OVPN-Script-V3/main/data/finish.sh
bash finish.sh
